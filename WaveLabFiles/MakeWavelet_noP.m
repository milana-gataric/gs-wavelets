function wave = MakeWavelet_noP(j,k,Family,par,Gender,n)

% EDIT of the file 'MakeWavelet' from  'Wavelab850/Orthogonal/' by Milana Gataric: 
% This function uses 'IWT_CDJV_noP' from matlab package gs_wavelets instead
% of 'IWT_CDJV' from Wavelab package
